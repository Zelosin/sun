...
namespace Ink.UnityIntegration {
    ...
    public class InkBrowserIcons {
        ...
        private static bool isRetina {
            get {
                var unityVersion = float.Parse(Application.unityVersion.Substring(0, 3));
        ...
        public static Texture2D inkFileIconLarge {
            get {
                if (_inkFileIconLarge == null) _inkFileIconLarge = Resources.Load<Texture2D>("InkFileIcon-large");
        ...
        public static Texture2D errorIcon {
            get {
                if (_errorIcon == null) _errorIcon = Resources.Load<Texture2D>("InkErrorIcon");
                return _errorIcon;
            }
        }
        ...
        public static Texture2D warningIcon {
            get {
                if (_warningIcon == null) _warningIcon = Resources.Load<Texture2D>("InkWarningIcon");
                return _warningIcon;
            }
        }
        ...
        public static Texture2D todoIcon {
            get {
                if (_todoIcon == null) _todoIcon = Resources.Load<Texture2D>("InkTodoIcon");
                return _todoIcon;
            }
        }
        ...
        public static Texture2D manualIcon {
            get {
                if (_manualIcon == null) _manualIcon = Resources.Load<Texture2D>("InkCompileManualIcon");
                return _manualIcon;
            }
        }
        ...
        public static Texture2D childIcon {
            get {
                if (_childIcon == null) _childIcon = Resources.Load<Texture2D>("InkChildIcon");
                return _childIcon;
            }
        }
        ...
        public static Texture2D childIconLarge {
            get {
                if (_childIconLarge == null) _childIconLarge = Resources.Load<Texture2D>("InkChildIcon-Large");
        ...
        public static Texture2D unknownFileIcon {
            get {
                if (_unknownFileIcon == null) _unknownFileIcon = Resources.Load<Texture2D>("InkUnknownFileIcon");
        ...
        private static void DrawLarge(InkFile inkFile, Rect rect) {
            ...
            if (inkFile == null) {
                if (unknownFileIcon != null) GUI.DrawTexture(miniRect, unknownFileIcon);
            }
            else {
                ...
                else if (inkFile.hasTodos && todoIcon != null) GUI.DrawTexture(miniRect, todoIcon);
        ...
        private static void DrawSmall(InkFile inkFile, Rect rect) {
            ...
            if (inkFile == null) {
                if (unknownFileIcon != null)
                    GUI.DrawTexture(new Rect(rect.x, rect.y, unknownFileIcon.width, unknownFileIcon.height),
                        unknownFileIcon);
            }
            else {
                if (!InkSettings.instance.compileAutomatically && !inkFile.compileAutomatically && inkFile.isMaster)
                    GUI.DrawTexture(
                        new Rect(rect.x, rect.y + rect.size.y * 0.5f, rect.size.x * 0.5f, rect.size.y * 0.5f),
                        manualIcon);
