...
namespace Ink.Runtime {
    public class ListDefinitionsOrigin {
        private readonly Dictionary<string, ListValue> _allUnambiguousListValueCache;

        private readonly Dictionary<string, ListDefinition> _lists;
        ...
        public List<ListDefinition> lists {
            get {
                ...
                foreach (var namedList in _lists) listOfLists.Add(namedList.Value);
                return listOfLists;
            }
        }
