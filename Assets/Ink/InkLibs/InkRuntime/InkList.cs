...
namespace Ink.Runtime {
    ...
    public struct InkListItem {
        ...
        public static InkListItem Null => new(null, null);

        public bool isNull => originName == null && itemName == null;

        /// <summary>
        ///     Get the full dot-separated name of the item, in the form "listDefinitionName.itemName".
        /// </summary>
        public string fullName => (originName ?? "?") + "." + itemName;
        ...
        public override int GetHashCode() {
            var originCode = 0;
            var itemCode = itemName.GetHashCode();
            if (originName != null)
    ...
    public class InkList : Dictionary<InkListItem, int> {
        ...
        public InkList(InkList otherList) : base(otherList) {
            ...
            if (otherList.origins != null) origins = new List<ListDefinition>(otherList.origins);
        }
        ...
        public InkList(string singleOriginListName, Story originStory) {
            ...
            if (originStory.listDefinitions.TryListGetDefinition(singleOriginListName, out def))
                ...
                throw new Exception("InkList origin could not be found in story when constructing new list: " +
        ...
        public KeyValuePair<InkListItem, int> maxItem {
            get {
                var max = new KeyValuePair<InkListItem, int>();
                ...
                if (origin.ContainsItemWithName(itemName)) {
                    if (foundListDef != null)
                        throw new Exception("Could not add the item " + itemName +
                                            " to this list because it could come from either " + origin.name + " or " +
                                            foundListDef.name);
                    foundListDef = origin;
                }
        ...
        public InkList Union(InkList otherList) {
            ...
            foreach (var kv in otherList) union[kv.Key] = kv.Value;
            return union;
        }
