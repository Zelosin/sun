...
namespace Ink.Parsed {
    public class Path {
        private readonly FlowLevel? _baseTargetLevel;
        ...
        public bool baseLevelIsAmbiguous => _baseTargetLevel == null;
        ...
        public Object ResolveFromContext(Object context) {
            ...
            if (baseTargetObject == null) return null;

            // Given base of path, resolve final target by working deeper into hierarchy
            //  e.g. ==> base.mid.FINAL
            if (components.Count > 1) return ResolveTailComponents(baseTargetObject);
        ...
        private Object TryGetChildFromContext(Object context, string childName, FlowLevel? minimumLevel,
