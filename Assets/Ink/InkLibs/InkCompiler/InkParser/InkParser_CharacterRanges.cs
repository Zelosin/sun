namespace Ink {
    public partial class InkParser {
        ...
        public static readonly CharacterRange
            LatinExtendedA = CharacterRange.Define('\u0100', '\u017F'); // no excludes here

        public static readonly CharacterRange
            LatinExtendedB = CharacterRange.Define('\u0180', '\u024F'); // no excludes here

        public static readonly CharacterRange Greek =
            CharacterRange.Define('\u0370', '\u03FF',
        ...
        public static readonly CharacterRange Armenian =
            CharacterRange.Define('\u0530', '\u058F',
                new CharacterSet().AddCharacters("\u0530").AddRange('\u0557', '\u0560').AddRange('\u0588', '\u058E'));

        public static readonly CharacterRange Hebrew =
            CharacterRange.Define('\u0590', '\u05FF', new CharacterSet());

        public static readonly CharacterRange Arabic =
            CharacterRange.Define('\u0600', '\u06FF', new CharacterSet());

        public static readonly CharacterRange Korean =
            CharacterRange.Define('\uAC00', '\uD7AF', new CharacterSet());
        ...
        private void ExtendIdentifierCharacterRanges(CharacterSet identifierCharSet) {
            ...
            foreach (var charRange in characterRanges) identifierCharSet.AddCharacters(charRange.ToCharacterSet());
        }
